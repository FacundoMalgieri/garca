  ...
  return (
    <div className={cn("relative", className)} ref={dropdownRef}>
      <button
        ...
        className={cn(
          "flex items-center justify-between gap-2 w-full px-3 py-2 text-base rounded-lg border border-border bg-white dark:bg-background text-foreground cursor-pointer transition-colors",
