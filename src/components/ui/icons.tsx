...
export function PayPalIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944 3.72a.77.77 0 0 1 .757-.629h6.724c2.332 0 4.144.642 5.244 1.857.518.573.886 1.243 1.094 1.99.219.79.258 1.737.114 2.814-.165 1.234-.523 2.303-1.063 3.176-.495.8-1.13 1.47-1.887 1.987-.735.503-1.59.872-2.54 1.098-.918.218-1.93.328-3.007.328H8.65a.77.77 0 0 0-.758.628l-.816 4.368zM18.452 7.532c-.061.457-.145.89-.255 1.298-.623 2.317-2.206 3.376-5.145 3.376h-1.24a.77.77 0 0 0-.758.629l-.925 4.94-.263 1.405a.641.641 0 0 0 .633.74h3.265a.77.77 0 0 0 .757-.628l.312-1.663.69-3.687a.77.77 0 0 1 .757-.629h.477c3.093 0 5.508-1.258 6.213-4.896.295-1.524.142-2.795-.428-3.683a3.996 3.996 0 0 0-1.09-.902 8.164 8.164 0 0 1 .255 1.298c.105.788.105 1.635 0 2.402z" />
    </svg>
  );
}

export function GitHubSponsorsIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
