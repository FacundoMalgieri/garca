...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "¡Sí! Podés exportar tus comprobantes a Excel (CSV), JSON o PDF. El PDF incluye gráficos y un resumen de tu situación en Monotributo, ideal para compartir con tu contador.",
  },
  {
    question: "¿Es gratis?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Primero verificá que tus credenciales de ARCA sean correctas. Si el error persiste, puede ser que ARCA esté experimentando problemas (suele pasar). Esperá unos minutos e intentá de nuevo. Si sigue fallando, podés reportar el problema en GitHub.",
  },
];
...
const MONOTRIBUTO_GUIDES = [
  {
    ...
    description:
      "Cuándo corresponde, qué mira ARCA y qué pasa si no la hacés en enero o julio.",
  ...
  },
  {
    ...
    description:
      "IVA, Ganancias, obligaciones formales y cuándo conviene dar el salto de régimen.",
  ...
  },
  {
    ...
    description:
      "Recategorización de oficio, exclusión del régimen y cómo volver si ya te excluyeron.",
...
const currencyColors: Record<string, string> = {
  ...
  green:
    "from-green-500/10 to-emerald-500/10 dark:from-green-500/20 dark:to-emerald-500/20 text-green-600 dark:text-green-400 border-green-200 dark:border-green-800/50",
  amber:
    "from-amber-500/10 to-orange-500/10 dark:from-amber-500/20 dark:to-orange-500/20 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-800/50",
  ...
  return (
    <>
      ...
      <section
        ...
        className="relative pt-0 pb-24 md:pb-32 -mt-16 md:-mt-24 overflow-hidden"
      >
        <div
        ...
        >
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">y más...</p>
        </div>
      </section>
          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 dark:from-blue-950/40 dark:via-indigo-950/30 dark:to-cyan-950/40 border border-blue-200 dark:border-blue-800/30 p-8 md:p-10 overflow-hidden shadow-[0_8px_40px_-8px_rgba(59,130,246,0.25)] dark:shadow-none hover:shadow-[0_12px_50px_-8px_rgba(59,130,246,0.35)] transition-shadow duration-500">
            ...
            <div className="relative text-center">
              ...
              <p className="text-sm md:text-base text-slate-600 dark:text-slate-400 max-w-xl mx-auto mb-8 leading-relaxed">
                Ingresá tu facturación mes a mes y descubrí en qué categoría vas a quedar en tu
                próxima recategorización. Planificá cuánto podés facturar para no pasarte de
                categoría.{" "}
                <strong className="text-slate-800 dark:text-slate-200">
                  Sin login, sin registrarte.
                </strong>
              </p>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              style={{
                opacity: supportVisible ? 1 : 0,
                transform: supportVisible ? "translateX(0) rotate(0deg)" : "translateX(0px)",
      ...
      >
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              Artículos y guías para entender el régimen, planificar tu año y resolver las dudas
              más comunes. Datos tomados directo de ARCA y actualizados cada semestre.
            </p>
          </div>
          ...
          <Link
            ...
            style={{
              ...
              transition:
                "opacity 700ms ease-out, transform 700ms ease-out, box-shadow 300ms ease-out",
              transitionDelay: "250ms",
            }}
          >
            <div
              className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-br from-blue-400/25 to-indigo-400/25 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3 pointer-events-none"
              aria-hidden
            />
            <div
              className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-cyan-400/20 to-blue-400/20 rounded-full blur-2xl -translate-x-1/2 translate-y-1/2 pointer-events-none"
              aria-hidden
            />
            ...
            <div className="relative flex flex-col md:flex-row md:items-center gap-5 md:gap-8">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed mb-4 max-w-2xl">
                  La página de referencia completa: las 11 categorías vigentes de la A a la K con
                  sus cuotas mensuales, topes de facturación anual y desglose de aportes. Datos
                  oficiales de ARCA.
                </p>
          ...
          >
            ...
            <span
              className="flex-1 h-px bg-gradient-to-r from-slate-200 to-transparent dark:from-slate-700/60"
              aria-hidden
            />
          </div>
      ...
      >
        <div
          ...
          style={{
            transform: `translateY(${
              faqProgress < 0.2
                ? (1 - faqProgress / 0.2) * 60
                : faqProgress > 0.7
                  ? -((faqProgress - 0.7) / 0.3) * 150
                  : 0
            }px)`,
            opacity:
              faqProgress < 0.2
                ? faqProgress / 0.2
                : faqProgress > 0.7
                  ? Math.max(0, 1 - (faqProgress - 0.7) / 0.4)
                  : 1,
          }}
        >
          <div className="text-center mb-12">
