 ...
 */
export function TurnstileWidget({ onSuccess, onError, onExpired }: TurnstileWidgetProps) {
  ...
  // Container must be visible for Turnstile to work
  // Using minimal height - will expand if challenge needed
  return (
    <div 
      ref={containerRef} 
